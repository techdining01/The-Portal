...
from .signals import backup_webhook_processing
...
class WebhookHandler:
    ...
    def handle_charge_success(self, data, gateway):
        """Handle successful charge with backup"""
        ...
        try:
            ...
            backup_webhook_processing(payment, data)
            ...
            if gateway == 'paystack':
                ...
                if verification['status'] and verification['data']['status'] == 'success':
                    ...
                    # Create backup before final update
                    backup_webhook_processing(payment, verification['data'])
                    ...
                    # Final backup after successful processing
                    backup_service.backup_payment(
                        payment,
                        backup_type='verification',
                        reason="Payment successfully verified and completed"
                    )
